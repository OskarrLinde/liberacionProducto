    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            try
            {
                ...
                //bool WSMexeFuncionalidad = false;
                ...
                var userTestJson = JsonConvert.SerializeObject(await _userManager.GetUsersInRoleAsync(SecurityConstants.PERFIL_ADMIN));
                ...
                if (User != null)
                {
                    ...
                    else if (Authorizate)
                    {
                        ...
                        //return RedirectToAction("Grado", "CertCatalogos");
            ...
            catch (Exception ex)
            {
                ...
                else
                {
                    ...
                    ModelState.AddModelError("LoginError", "Surgio un error.");
                }
