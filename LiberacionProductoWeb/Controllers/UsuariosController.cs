...
namespace LiberacionProductoWeb.Controllers
{
    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> UsuariosAsync(List<String> SelectedPlantsFilter, List<String> SelectedUsersFilter, List<String> SelectedProfilesFilter, List<String> SelectedStatusFilter)
        {
