...
namespace LiberacionProductoWeb.Controllers
{
    ...
    public class PerfilesController : Controller
    {
        ...
        public PerfilesController(UserManager<ApplicationUser> userManager,
        ...
        [HttpGet]
        [Authorize(SecurityConstants.CONSULTAR_CATALOGO_DE_ROLES)]
        public async Task<IActionResult> Perfiles(List<String> SelectedRoleFilter, List<String> SelectedFunctionsFilter)
        {
        ...
        public async Task<IActionResult> Perfiles(PerfilesViewModel model)
        {
