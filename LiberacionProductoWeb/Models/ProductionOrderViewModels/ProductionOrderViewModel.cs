...
namespace LiberacionProductoWeb.Models.ProductionOrderViewModels
{
    public class ProductionOrderViewModel : SechToolDistributionBatchVM
    {
        public ProductionOrderViewModel()
        {
            ...
            this.LayoutLeyends = new List<LayoutLeyendsProductionOrderVM>();
            this.ProductionOrderCustomersFilesViewModel = new List<ProductionOrderCustomersFilesViewModel>();
        }
        ...
        public List<LayoutLeyendsProductionOrderVM> LayoutLeyends { get; set; }
        public Guid GroupId { get; set; }
        public string TableName { get; set; }
        public string DelegateUser { get; set; }
        public string FileName { get; set; }
        public List<ProductionOrderCustomersFilesViewModel> ProductionOrderCustomersFilesViewModel { get; set; }
    }
