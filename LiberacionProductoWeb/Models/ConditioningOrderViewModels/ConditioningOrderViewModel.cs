...
namespace LiberacionProductoWeb.Models.ConditioningOrderViewModels
{
    public class ConditioningOrderViewModel : SechToolDistributionBatchVM
    {
        public ConditioningOrderViewModel()
        {
            ...
            PreviewText = false;
            LayoutLeyends = new List<LayoutLeyendsConditioningOrderVM>();
        }
        ...
        public List<LayoutLeyendsConditioningOrderVM> LayoutLeyends { get; set; }
    ...
    public class ConditioningOrderStatus
    {
        ...
        public static ConditioningOrderStatus Released { get { return new ConditioningOrderStatus("Expediente de lote cerrado"); } }
        ...
        public static ConditioningOrderStatus ReleasedOld { get { return new ConditioningOrderStatus("OA-Liberada"); } }
    }
