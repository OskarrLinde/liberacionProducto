...
namespace LiberacionProductoWeb.Helpers
{
    ...
    public class RunDtoMapper : Profile
    {
        public RunDtoMapper()
        {
            ...
            CreateMap<LayoutLeyendsProductionOrderVM, LeyendsText>().ReverseMap();
            CreateMap<LayoutLeyendsProductionOrderVM, LeyendsPreviewText>().ReverseMap();
            CreateMap<LayoutLeyendsConditioningOrderVM, LeyendsText>().ReverseMap();
            CreateMap<LayoutLeyendsConditioningOrderVM, LeyendsPreviewText>().ReverseMap();
            CreateMap<LeyendsText, LeyendsTextHistory>().ReverseMap();
            CreateMap<LayoutLeyendsCheckListVM, LeyendsText>().ReverseMap();
            CreateMap<LayoutLeyendsCheckListVM, LeyendsPreviewText>().ReverseMap();
            CreateMap<LeyendsText, LeyendsPreviewText>().ReverseMap();
            CreateMap<ProductionOrderCustomersFiles, ProductionOrderCustomersFilesViewModel>().ReverseMap();
        }
    }
}
