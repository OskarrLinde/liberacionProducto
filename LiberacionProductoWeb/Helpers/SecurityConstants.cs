namespace LiberacionProductoWeb.Helpers
{
    public class SecurityConstants
    {
        ...
        public const string CONSULTAR_LAYOUT_ORDEN_PRODUCCION_CONDITIONING = "c27";
        public const string EDITAR_LAYOUT_ORDEN_PRODUCCION_CONDITIONING = "c28";
        public const string CONSULTAR_LAYOUT_CHECKLIST = "d1";
        public const string EDITAR_LAYOUT_CHECKLIST = "d2";
